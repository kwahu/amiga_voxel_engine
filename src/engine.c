...
void DrawPlayerScreen4x4(UBYTE *screen, UBYTE player, UBYTE depth, UBYTE startScreen, UBYTE xCycles)
{
	...
	dither1 = colorByteDither4x4EvenP1;
	dither2 = colorByteDither4x4EvenP2;
	dither3 = colorByteDither4x4EvenP3;
	dither4 = colorByteDither4x4EvenP4;

	dither5 = colorByteDither4x4OddP1;
	dither6 = colorByteDither4x4OddP2;
	dither7 = colorByteDither4x4OddP3;
	dither8 = colorByteDither4x4OddP4;
...
void ProcessRayCastsWithMipMaps(UBYTE *screen, UBYTE px, UBYTE py, UBYTE ph,
	UBYTE tableXStart,	UBYTE tableStepSizeX, UBYTE tableStepSizeY, UBYTE tableStepNumber, UBYTE xCycles)
{
	UBYTE sx,sy,tz;
	UBYTE th = 0;
