...
WORD rayCastXX[40*TERRAINDEPTH];
WORD rayCastYY[32*TERRAINDEPTH];
...
UBYTE dither8x8EvenP1[COLORS];
UBYTE dither8x8EvenP2[COLORS];
UBYTE dither8x8EvenP3[COLORS];
UBYTE dither8x8EvenP4[COLORS];
UBYTE dither8x8OddP1[COLORS];
UBYTE dither8x8OddP2[COLORS];
UBYTE dither8x8OddP3[COLORS];
UBYTE dither8x8OddP4[COLORS];
