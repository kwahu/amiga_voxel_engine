...
if(debugValue == 1)
{
	...
	ProcessRayCasts16(screen4x4b,rayCastXEven, rayCastYEven,mapHigh,p1x,p1y,p1h,	16, 2, 2, 0, 16,4,12,YSIZEEVEN, xOffsetEven);
	ProcessRayCasts16(screen4x4c,rayCastXEven, rayCastYEven,mapHigh,p1x,p1y,p1h,	48, 2, 2, 0, 16,4,12,YSIZEEVEN, xOffsetEven);
	ProcessRayCasts16(screen4x4d,rayCastXEven, rayCastYEven,mapHigh,p1x,p1y,p1h,	80, 2, 2, 0, 16,4,12,YSIZEEVEN, xOffsetEven);
...
else if(debugValue == 2)
{
	...
	ProcessRayCasts16(screen4x4a,rayCastXEven, rayCastYEven,mapHigh,p1x,p1y,p1h,	0,  1, 1, 0, 16,4,12,YSIZEEVEN, xOffsetEven);
	ProcessRayCasts16(screen4x4b,rayCastXEven, rayCastYEven,mapHigh,p1x,p1y,p1h,	16, 1, 1, 0, 16,4,12,YSIZEEVEN, xOffsetEven);
	ProcessRayCasts16(screen4x4c,rayCastXEven, rayCastYEven,mapHigh,p1x,p1y,p1h,	32, 1, 1, 0, 16,4,12,YSIZEEVEN, xOffsetEven);
	ProcessRayCasts16(screen4x4d,rayCastXEven, rayCastYEven,mapHigh,p1x,p1y,p1h,	48, 1, 1, 0, 16,4,12,YSIZEEVEN, xOffsetEven);
	ProcessRayCasts16(screen4x4e,rayCastXEven, rayCastYEven,mapHigh,p1x,p1y,p1h,	64, 1, 1, 0, 16,4,12,YSIZEEVEN, xOffsetEven);
...
else if(debugValue == 3)
{
	...
	ProcessRayCasts16(screen8x8a,rayCastXEven, rayCastYEven,mapHigh,p1x,p1y,p1h,	0,  2, 2, 0, 8,4,12,YSIZEEVEN, xOffsetEven);
	ProcessRayCasts16(screen4x4b,rayCastXEven, rayCastYEven,mapHigh,p1x,p1y,p1h,	16, 1, 1, 0, 16,4,12,YSIZEEVEN, xOffsetEven);
	ProcessRayCasts16(screen3x2c,rayCastXOdd, rayCastYOdd,mapHigh,p1x,p1y,p1h,	48, 1, 1, 0, 24,4,12,YSIZEODD, xOffsetOdd);
	ProcessRayCasts16(screen4x4d,rayCastXEven, rayCastYEven,mapHigh,p1x,p1y,p1h,	48, 1, 1, 0, 16,4,12,YSIZEEVEN, xOffsetEven);
	ProcessRayCasts16(screen8x8e,rayCastXEven, rayCastYEven,mapHigh,p1x,p1y,p1h,	64, 2, 2, 0, 8,4,12,YSIZEEVEN, xOffsetEven);
...
else if(debugValue == 7)
{
	...
	ProcessRayCastsFull(screen3x2a,rayCastXOdd, rayCastYOdd,mapHigh,p1x,p1y,p1h,0,  1, 1, 0, 24,1,12,YSIZEODD, xOffsetOdd);
	...
	ProcessRayCastsFull(screen3x2e,rayCastXOdd, rayCastYOdd,mapHigh,p1x,p1y,p1h,96, 1, 1, 0, 24,1,12,YSIZEODD, xOffsetOdd);
...
else if(debugValue == 8)
{
	...
	//ProcessRayCasts3x2(rayCastXOdd, rayCastYOdd,mapHigh,p1x,p1y,p1h,0,   4,1,12,YSIZEODD, xOffsetOdd);
	ProcessRayCasts3x2(rayCastXOdd, rayCastYOdd,mapHigh,p1x,p1y,p1h,24,  4,1,12,YSIZEODD, xOffsetOdd);
	ProcessRayCasts3x2(rayCastXOdd, rayCastYOdd,mapHigh,p1x,p1y,p1h,48,  4,1,12,YSIZEODD, xOffsetOdd);
	ProcessRayCasts3x2(rayCastXOdd, rayCastYOdd,mapHigh,p1x,p1y,p1h,72,  4,1,12,YSIZEODD, xOffsetOdd);
	//ProcessRayCasts3x2(rayCastXOdd, rayCastYOdd,mapHigh,p1x,p1y,p1h,96,  4,1,12,YSIZEODD, xOffsetOdd);
