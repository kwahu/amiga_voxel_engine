...
if(debugValue == 1)
{
	...
	ProcessRayCasts16(screen4x4b,rayCastXEven, rayCastYEven,mapHigh,p1x,p1y,p1h,	16, 2, 2, 0, 16,4,2,YSIZEEVEN, xOffsetEven);
	ProcessRayCasts16(screen4x4c,rayCastXEven, rayCastYEven,mapHigh,p1x,p1y,p1h,	48, 2, 2, 0, 16,4,3,YSIZEEVEN, xOffsetEven);
	ProcessRayCasts16(screen4x4d,rayCastXEven, rayCastYEven,mapHigh,p1x,p1y,p1h,	80, 2, 2, 0, 16,4,2,YSIZEEVEN, xOffsetEven);
...
else if(debugValue == 2)
{
	...
	ProcessRayCasts16(screen4x4b,rayCastXEven, rayCastYEven,mapHigh,p1x,p1y,p1h,	16, 1, 1, 0, 16,4,2,YSIZEEVEN, xOffsetEven);
	ProcessRayCasts16(screen4x4c,rayCastXEven, rayCastYEven,mapHigh,p1x,p1y,p1h,	32, 1, 1, 0, 16,4,3,YSIZEEVEN, xOffsetEven);
	ProcessRayCasts16(screen4x4d,rayCastXEven, rayCastYEven,mapHigh,p1x,p1y,p1h,	48, 1, 1, 0, 16,4,2,YSIZEEVEN, xOffsetEven);
...
else if(debugValue == 3)
{
	...
	ProcessRayCasts16(screen8x8a,rayCastXEven, rayCastYEven,mapHigh,p1x,p1y,p1h,	0,  2, 2, 0, 8,4,1,YSIZEEVEN, xOffsetEven);
	ProcessRayCasts16(screen4x4b,rayCastXEven, rayCastYEven,mapHigh,p1x,p1y,p1h,	16, 1, 1, 0, 16,4,2,YSIZEEVEN, xOffsetEven);
	ProcessRayCasts16(screen3x2c,rayCastXOdd, rayCastYOdd,mapHigh,p1x,p1y,p1h,	48, 1, 1, 0, 24,4,3,YSIZEODD, xOffsetOdd);
	ProcessRayCasts16(screen4x4d,rayCastXEven, rayCastYEven,mapHigh,p1x,p1y,p1h,	48, 1, 1, 0, 16,4,2,YSIZEEVEN, xOffsetEven);
	ProcessRayCasts16(screen8x8e,rayCastXEven, rayCastYEven,mapHigh,p1x,p1y,p1h,	64, 2, 2, 0, 8,4,1,YSIZEEVEN, xOffsetEven);
...
else if(debugValue == 4)
{
	...
	ProcessRayCastsFull(screen4x4a,rayCastXEven, rayCastYEven,mapHigh,p1x,p1y,p1h,	0,  1, 1, 0, 16,2,3,YSIZEEVEN, xOffsetEven);
	ProcessRayCastsFull(screen4x4b,rayCastXEven, rayCastYEven,mapHigh,p1x,p1y,p1h,	16, 1, 1, 0, 16,2,4,YSIZEEVEN, xOffsetEven);
	ProcessRayCastsFull(screen3x2c,rayCastXOdd, rayCastYOdd,mapHigh,p1x,p1y,p1h,	48, 1, 1, 0, 24,2,5,YSIZEODD, xOffsetOdd);
	ProcessRayCastsFull(screen4x4d,rayCastXEven, rayCastYEven,mapHigh,p1x,p1y,p1h,	48, 1, 1, 0, 16,2,4,YSIZEEVEN, xOffsetEven);
	ProcessRayCastsFull(screen4x4e,rayCastXEven, rayCastYEven,mapHigh,p1x,p1y,p1h,	64, 1, 1, 0, 16,2,3,YSIZEEVEN, xOffsetEven);
...
else if(debugValue == 5)
{
	...
	ProcessRayCastsFull(screen3x2c,rayCastXOdd, rayCastYOdd,mapHigh,p1x,p1y,p1h,	48, 1, 1, 0, 24,2,5,YSIZEODD, xOffsetOdd);
	ProcessRayCastsFull(screen3x2d,rayCastXOdd, rayCastYOdd,mapHigh,p1x,p1y,p1h,	72, 1, 1, 0, 24,2,4,YSIZEODD, xOffsetOdd);
	ProcessRayCastsFull(screen4x4e,rayCastXEven, rayCastYEven,mapHigh,p1x,p1y,p1h,	64, 1, 1, 0, 16,2,3,YSIZEEVEN, xOffsetEven);
...
else if(debugValue == 6)
{
	...
	ProcessRayCastsFull(screen3x2c,rayCastXOdd, rayCastYOdd,mapHigh,p1x,p1y,p1h,48, 1, 1, 0, 24,2,5,YSIZEODD, xOffsetOdd);
	ProcessRayCastsFull(screen3x2d,rayCastXOdd, rayCastYOdd,mapHigh,p1x,p1y,p1h,	72, 1, 1, 0, 24,2,4,YSIZEODD, xOffsetOdd);
	ProcessRayCastsFull(screen3x2e,rayCastXOdd, rayCastYOdd,mapHigh,p1x,p1y,p1h,	96, 1, 1, 0, 24,2,3,YSIZEODD, xOffsetOdd);
